...
import { Mic, ArrowRight, Mail, CheckCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-cream dark:bg-[#0F0F14] flex items-center justify-center px-4 transition-colors">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted dark:text-gray-400 text-sm mt-1">Log in to your EchoThread journal</p>
        </div>
        ...
        {step === "email" ? (
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            ...
            <p className="text-center text-sm text-muted dark:text-gray-400">
              New here?{" "}
              <Link href="/register" className="text-coral-500 font-medium hover:underline">
                Create an account
              </Link>
            </p>
          </form>
          ...
          <div className="space-y-4">
            {success ? (
              <div className="text-center py-8">
                ...
                <p className="text-ink dark:text-white font-semibold">Verified! Redirecting...</p>
              </div>
            ) : (
              <>
